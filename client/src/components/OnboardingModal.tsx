    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ul className="how-to-play">
          <li>
            <span>01</span><div><strong>$20 budget</strong>Draft one player at PG, SG, SF, PF, and C.</div>
          </li>
          <li>
            <span>02</span><div><strong>Random reveals</strong>Players appear one at a time and opening possession alternates.</div>
          </li>
          <li>
            <span>03</span><div><strong>Bid or fold</strong>Raise the price or let the other GM take the card at their bid.</div>
          </li>
          <li>
            <span>04</span><div><strong>One skip</strong>The other GM can claim a skipped card for $1 or remove it from the board.</div>
          </li>
          <li>
            <span>05</span><div><strong>Lineup matters</strong>Rearrange freely. Playing out of position carries a realistic penalty.</div>
          </li>
          <li>
            <span>06</span><div><strong>Highest score wins</strong>Stats, accolades, chemistry, fit, and positioning decide the matchup.</div>
          </li>
        </ul>
