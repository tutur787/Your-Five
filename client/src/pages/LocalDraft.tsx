...
export function LocalDraft() {
  ...
  const runtime = useSportRuntime(sport, footballCompetition, `local:${draftKey}`);
  ...
  return (
    <div className="game-page">
      <AppHeader
        eyebrow="LOCAL MATCH"
        title="Couch draft"
        detail={`Pass the screen when possession changes${runtime.sport === "soccer" ? ` · ${footballCompetitionLabel(runtime.competition)}` : ""}`}
